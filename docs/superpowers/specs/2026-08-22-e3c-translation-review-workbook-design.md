...
- macros, external integrations, or a web application;
...
- no formulas, macros, or external links generated by the exporter;
...
- any cell contains a formula or the workbook contains unexpected sheets;
  Excel data-validation rules generated by the exporter remain allowed;
...
- optional-NMT tampering, extra sheets, and formulas;
